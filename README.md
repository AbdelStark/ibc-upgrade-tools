...
ibc-upgrade-tools/0.0.3 darwin-x64 node-v16.6.1
...
_See code: [src/commands/check/postmigration.ts](https://github.com/abdelhamidbakhta/ibc-upgrade-tools/blob/v0.0.3/src/commands/check/postmigration.ts)_
