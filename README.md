...
ibc-upgrade-tools/0.1.3 darwin-x64 node-v14.18.0
...
_See code: [src/commands/check/postmigration.ts](https://github.com/abdelhamidbakhta/ibc-upgrade-tools/blob/v0.1.3/src/commands/check/postmigration.ts)_
